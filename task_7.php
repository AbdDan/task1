        ...
        <main id="js-page-content" role="main" class="page-content">
            <div class="col-md-6">
                <div id="panel-1" class="panel">
                    ...
                    //          "tw_link_href" => "https://twitter.com/@myplaneticket",
                    //          "tw_link_text" => "@myplaneticket",
                    //          "email_link_href" => "https://twitter.com/@myplaneticket",
                    ...
                    //          "tw_link_href" => "https://twitter.com/@atlantez",
                    //          "tw_link_text" => "@atlantez",
                    ...
                    //          "job_title" => "Partner &amp; Contributor",
                    //          "tw_link_href" => "https://twitter.com/@lodev09",
                    //          "tw_link_text" => "@lodev09",
                    ...
                    //          "job_title" => "Partner &amp; Contributor",
                    //          "tw_link_href" => "https://twitter.com/@sildur",
                    //          "tw_link_text" => "@sildur",
                    ...
                    // ];
                                ...
                                // $dsn = "mysql:host=localhost;port=3307;dbname=tasks_db;charset=utf8";
                                ...
                                // $pdo = new PDO($dsn,$statement 'root', '', $options);                     
                                ...
                                // var_dump($pdo);die;
                                 ...
                                 // PDO::ATTR_DEFAULT_FETCH_MODE => PDO::FETCH_ASSOC
                                 // ];
                                 // $persons = $statement->fetchAll($options);
                           ...
                           <?php foreach ($persons as $person): ?> 
                            ...
                            <div class="<?php echo $person['status'] == 'banned' ? 'banned' : ''; ?> rounded-pill bg-white shadow-sm p-2 border-faded mr-3 d-flex flex-row align-items-center justify-content-center flex-shrink-0">
                                ...
                                <div class="ml-2 mr-3">
                                    ...
                                    <a href="<?php echo $person['tw_link_href'];?>" class="text-info fs-sm" target="_blank"><?php echo $person['tw_link_text'];?></a> -
                                    <a href="<?php echo $person['email_link_href'];?>" class="text-info fs-sm" target="_blank" title="email_link_title"><?php echo $person['email_link_text'];?></a>
                                </div>
                            </div>
